...
/*Differnet operations which may happen on the bus
 * Remember the sequence :-
 * After each operation , wait the flag untill the operation done ,
 * then check the status from its 5 bits
 * @ start register we will find the operations which we define there .
 **/
