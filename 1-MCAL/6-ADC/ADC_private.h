...
#define ADC_CH_MASK				    0b11100000  // clear the MUX register
...
#define ADSAR		       		*((volatile uint8*)0x26)		//ADC control and status register A
/* ADSAR Bits   */
...
/*Defining the state of current the ADC */
#define IDLE   0
#define BUSY   1
